...
install_requires = ['setuptools', 'mr.bobby', 'bobbyplugins.jpcw']


setup(name='bobbytemplates.jpcw',
      version=version,
      description="bobbytemplates basic_namespace",
      ...
      keywords='bobbytemplates',
      author='Jean-Philippe Camguilhem',
      author_email='jp.camguilhem@gmail.com',
      url='https://github.com/jpcw/bobbytemplates.jpcw',
      license='BSD',
